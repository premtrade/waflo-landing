...
const APP_URL = 'https://waflo-app.vercel.app'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <a href={`${APP_URL}/login`} className="text-sm font-medium text-surface-600 hover:text-surface-900">
                Sign In
              </a>
      ...
      <section className="py-20 bg-surface-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`${APP_URL}/signup`} className="btn-primary py-3 px-8 text-base">
              Get Started Free
            </a>
